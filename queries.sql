...
-- SELECT o.first_name, o.last_name, COUNT(owner_id) AS count FROM owners o JOIN vehicles v ON o.id = v.owner_id GROUP BY o.first_name, o.last_name ORDER BY o.first_name ASC;
...
-- SELECT o.first_name, o.last_name, AVG(price) AS average_price, COUNT(owner_id) AS count FROM owners o JOIN vehicles v ON o.id = v.owner_id GROUP BY o.first_name, o.last_name HAVING COUNT(owner_id) >= 2 AND AVG(price) > 10000 ORDER BY o.first_name DESC; 